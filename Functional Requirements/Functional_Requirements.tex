...
\begin{figure}
	\centering
	\includegraphics[height=130px]{../Images/CodusMaximus_logo.jpg}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[height=65px]{../Images/logo}
\end{figure}
...
%		\textbf{ }
		\begin{figure}[H]
			\centering
		%	\includegraphics[width=0.35\columnwidth]{../Images/Logo2}\\
		%	HyperPerform
		%	\url{https://www.hyperperform.me/}
		\end{figure}
	\end{minipage}
