...
\begin{itemize}
	\item After a user has been registered by the management their username and password will be emailed to the registered user
	\item The user should then navigate to the login page of the hyperperform system shown below:
\end{itemize}
	\includegraphics[height=250px, width=500px]{../Images/Login_Screen.jpg}
	\pagebreak
\begin{itemize}
	\item After logging in you will be redirected to the below page where you can view your current performance and integrations:
\end{itemize}
\includegraphics[height=300px, width=510px]{../Images/dashboard.jpg}
\end{document}